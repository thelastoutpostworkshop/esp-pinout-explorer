...
import { createEsp8266LauncherProfile } from './launcher';

export { wroom02Source, wroom02DuSource } from './moduleSources';

const esp8266BoardFactories: BoardProfileFactory[] = [
  createEsp8266DevKitCProfile,
  createEsp8266DevKitSProfile,
  createEsp8266LauncherProfile,
];
