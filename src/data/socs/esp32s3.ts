...
interface ConnectorBoardPinInput {
...
const esp32s3UsbOtgProfile: SocPackageVariant = {
  id: 'esp32s3-usb-otg',
  name: 'USB-OTG (MINI)',
...
esp32s3.boardProfiles = [esp32s3DevKitC1V11Profile, esp32s3DevKitM1Profile, esp32s3UsbOtgProfile];
