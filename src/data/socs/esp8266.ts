...
export const esp8266ex: SocDefinition = {
  ...
  pins: [
    ...
    io(9, 'MTMS', 14, { side: 'bottom', order: 1 }, {
    ...
    io(10, 'MTDI', 12, { side: 'bottom', order: 2 }, {
    ...
    pin(11, 'VDDPST', 'power', { side: 'bottom', order: 3 }, {
    ...
    io(12, 'MTCK', 13, { side: 'bottom', order: 4 }, {
    ...
    io(13, 'MTDO', 15, { side: 'bottom', order: 5 }, {
    ...
    io(14, 'GPIO2', 2, { side: 'bottom', order: 6 }, {
    ...
    io(15, 'GPIO0', 0, { side: 'bottom', order: 7 }, {
    ...
    io(16, 'GPIO4', 4, { side: 'bottom', order: 8 }, {
      mainFunctions: ['GPIO4', 'PWM3'],
      ioMux: ['GPIO4', 'PWM3'],
      keywords: ['pwm'],
    }),
    pin(17, 'VDDPST', 'power', { side: 'right', order: 8 }, {
      mainFunctions: ['Digital/IO power 1.8 V to 3.6 V'],
      notes: ['Digital and IO power supply.'],
      warnings: warnings('power', 'voltage'),
      keywords: ['power', 'digital', 'io power', 'vddpst', 'supply'],
    }),
    io(18, 'SDIO_DATA_2', 9, { side: 'right', order: 7 }, {
    ...
    io(19, 'SDIO_DATA_3', 10, { side: 'right', order: 6 }, {
    ...
    io(20, 'SDIO_CMD', 11, { side: 'right', order: 5 }, {
    ...
    io(21, 'SDIO_CLK', 6, { side: 'right', order: 4 }, {
    ...
    io(22, 'SDIO_DATA_0', 7, { side: 'right', order: 3 }, {
    ...
    io(23, 'SDIO_DATA_1', 8, { side: 'right', order: 2 }, {
    ...
    io(24, 'GPIO5', 5, { side: 'right', order: 1 }, {
      mainFunctions: ['GPIO5', 'IR Rx'],
      ioMux: ['GPIO5', 'IR Rx'],
      keywords: ['ir', 'infrared', 'rx'],
    }),
    io(25, 'U0RXD', 3, { side: 'top', order: 8 }, {
    ...
    io(26, 'U0TXD', 1, { side: 'top', order: 7 }, {
    ...
    pin(27, 'XTAL_OUT', 'analog', { side: 'top', order: 6 }, {
    ...
    pin(32, 'EXT_RSTB', 'control', { side: 'top', order: 1 }, {
