const exactDescriptions: Record<string, string> = {
  ...
  ANT_2G: 'Dedicated 2.4 GHz RF antenna connection. It is not a general GPIO.',
  '3V3 power supply': '3.3 V board power rail. Use according to the board guide power-supply options.',
  '5V power supply': '5 V board power rail. Use according to the board guide power-supply options.',
  'Crystal oscillator connection': 'Crystal oscillator connection used by the chip clock circuit.',
  ...
  '2.4 GHz RF antenna input/output': 'Dedicated 2.4 GHz RF antenna connection. It is not a general GPIO.',
  '3.3 V supply': '3.3 V supply rail provided by the development-board connector.',
  '5 GHz RF antenna input/output': 'Dedicated 5 GHz RF antenna connection. It is not a general GPIO.',
  BM_CS: 'Chip-select signal for the SensairShuttle Shuttle Board sensor interface.',
  BM_G1: 'First auxiliary/interrupt signal for the SensairShuttle Shuttle Board sensor interface.',
  BM_G2: 'Second auxiliary/interrupt signal for the SensairShuttle Shuttle Board sensor interface.',
  'BM_SCK/SCL': 'Shared Shuttle Board SPI clock or I2C clock signal on the SensairShuttle.',
  'BM_SDI/SDA': 'Shared Shuttle Board SPI data input or I2C data signal on the SensairShuttle.',
  BM_SDO: 'SPI data output signal for the SensairShuttle Shuttle Board sensor interface.',
  ...
  EXT_IO1: 'First external GPIO signal on the SensairShuttle external pin interface.',
  ...
  'LP digital power input': 'Power-supply input for the low-power digital domain. Follow the datasheet power scheme.',
  ...
  LCD_TP_SCL: 'LCD touch-panel I2C clock signal on the development board.',
  LCD_TP_SDA: 'LCD touch-panel I2C data signal on the development board.',
  ...
  PA_CTL: 'Speaker power-amplifier control signal on the SensairShuttle.',
  PAD_COMP0: 'Analog pad-comparator input 0 on supported ESP32-C5 configurations.',
  PAD_COMP1: 'Analog pad-comparator input 1 on supported ESP32-C5 configurations.',
  PCLK: 'Camera pixel clock signal.',
  POWER_CTRL: 'Power-control signal on the development board.',
  PWR_CTRL: 'LCD power-control signal on the SensairShuttle.',
  ...
  'Sensor supply': 'Power supply rail for a development-board sensor connector.',
  ...
  WS2812_CTRL: 'Data-control signal for a WS2812-compatible RGB LED strip interface.',
  ...
  SPICS: 'SPI chip-select signal. It may be used by the chip memory interface; check the package and module memory mapping before repurposing it.',
  ...
  USB_DM: 'USB differential-pair D- signal. Use it with USB_DP as a matched USB data pair.',
  USB_DP: 'USB differential-pair D+ signal. Use it with USB_DM as a matched USB data pair.',
  'VCCA/VDDPST_2': 'Analog and digital power-domain connection. Follow the datasheet power-supply and decoupling guidance; it is not a GPIO.',
  VDD_LDO_1P8: '1.8 V LDO power-domain connection. Follow the datasheet reference design; it is not a GPIO.',
  VDD_PSRAM_1P8_1: '1.8 V PSRAM power-domain connection. Follow the datasheet reference design; it is not a GPIO.',
  VDD_PSRAM_1P8_2: '1.8 V PSRAM power-domain connection. Follow the datasheet reference design; it is not a GPIO.',
  VDDPST_1: 'Digital power-domain connection. Follow the datasheet power-supply and decoupling guidance; it is not a GPIO.',
  VDDPST_3: 'Digital power-domain connection. Follow the datasheet power-supply and decoupling guidance; it is not a GPIO.',
  VDDPST_4: 'Digital power-domain connection. Follow the datasheet power-supply and decoupling guidance; it is not a GPIO.',
  VREF_ADC: 'ADC reference-voltage connection. Follow the datasheet analog reference design; it is not a GPIO.',
  VREF_TOUCH: 'Touch-sensor reference-voltage connection. Follow the datasheet analog reference design; it is not a GPIO.',
  'XTAL_32K_N/GPIO0': '32 kHz crystal negative connection, multiplexed with GPIO0. Follow the datasheet if using an external 32 kHz crystal.',
  'XTAL_32K_P/GPIO1': '32 kHz crystal positive connection, multiplexed with GPIO1. Follow the datasheet if using an external 32 kHz crystal.',
  ...
  VDDA1: 'Analog power-supply pin for the named chip domain. This is not a GPIO.',
  VDDA2: 'Analog power-supply pin for the named chip domain. This is not a GPIO.',
  VDDA3: 'Analog power-supply pin for the named chip domain. This is not a GPIO.',
  VDDA4: 'Analog power-supply pin for the named chip domain. This is not a GPIO.',
  VDDPST1: 'Digital power-supply pin for the named chip domain. This is not a GPIO.',
  VDDPST2: 'Digital power-supply pin for the named chip domain. This is not a GPIO.',
